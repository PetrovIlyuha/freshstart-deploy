...
const resovleBookingsIndex = (bookingsIndex, checkInDate, checkOutDate) => {
    ...
    while (dateCursor < checkOut) {
        ...
        if (!newBookingsIndex[year][month][day]) {
            ...
            throw new Error("Selected dates can't overlap the dates that have already been booked");
        }
        ...
        createBooking: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                if (checkOutDate < checkInDate) {
                    throw new Error("Checkout Date can't occur as being before Check-in Date");
                }
                const bookingsIndex = resovleBookingsIndex(listing.bookingsIndex, checkIn, checkOut);
                ...
                if (!host || !host.walletId) {
                    throw new Error("The host either can't be found or is not connected with Stripe account");
                }
                ...
                const insertedBooking = insertResult.ops[0];
